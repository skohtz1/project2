...
cost_url = "https://api.data.gov/ed/collegescorecard/v1/schools.json?&_per_page=50&_fields=2013.cost.attendance.academic_year,2013.earnings.6_yrs_after_entry.median,2015.student.undergrads_with_pell_grant_or_federal_student_loan,school.name&school.online_only=0&2015.student.size__range=1100..&api_key=TZzGbQIxCUsSuRlsV8kGenTldy3nkn1bAQOqjezi"
...
#     print(program_list)
    ...
    #         sub_data_list = []
            ...
            if "_fields=2013.cost.attendance.academic_year" in url:
                cost = db.cost.find()
